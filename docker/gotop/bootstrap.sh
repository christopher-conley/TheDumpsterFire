...
&& ln -s /usr/lib/libproc2.so.0.0.2 /usr/lib/libproc2.so.0 \
&& ln -s /usr/lib/libintl.so.8.4.0 /usr/lib/libintl.so.8 \
...
&& ln -s /bin/busybox /sbin/inotifyd \
...
&& ln -s /bin/busybox /usr/bin/lzopcat \
...
&& ln -s /bin/busybox /usr/sbin/ntpd \
