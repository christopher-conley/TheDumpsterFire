...
using RosettaTools.Pwsh.Text.SpectreLogger.Helpers;
using System;
...
namespace RosettaTools.Pwsh.Text.SpectreLogger.Helpers {
    internal class Utilities : SpectreLoggerPSCmdlet {
        ...
        public static void ShowLogo() {
            ...
            using (new StreamReader(stream)) {
                ...
                try {
                    ...
                    logoText = new FigletText(font, "RosettaTools Pwsh SpectreLogger")
                        .Centered()
                        .Color(Color.Red);
                    if ((null == logoText) || (font == FigletFont.Default)) {
                        AnsiConsole.MarkupLine("[bright yellow]RosettaTools Pwsh SpectreLogger[/]");
                        return;
                    }
                    ...
                    AnsiConsole.MarkupLine("[bright yellow]CRosettaTools Pwsh SpectreLogger[/]");
                    return;
                }
            }
        }
